    ...
    <header class="header" id="header">
      <nav>
        <ul class="nav-list">
          ...
          <li class="nav-item"><a href="contact.php" class="active">Contact us</a></li>
          <?php
          ...
          <div class="footerinfo">
            ...
            <div class="foot-nav">
              <ul class="foot-nav-list">
                ...
                <li class="foot-nav-item"><a href="about.php">About us</a></li>
                <li class="foot-nav-item"><a href="#header" class="active">contact us</a></li>
              </ul>
            </div>
  </body>
</html>
